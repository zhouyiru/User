...
<html>
  ...
  <tr><td bgcolor="#FFCCFF" align="center"><b>用户名</b></td><td><input type="text" name="username" value="<%=rs.getString("username") %>" readonly/></td></tr>
  <tr><td bgcolor="#FFCCFF" align="center"><b>密&nbsp;码</b></td><td><input type="text" name="userpwd" value="<%=rs.getString("userpwd") %>" readonly/></td></tr>
  <tr><td bgcolor="#FFCCFF" align="center"><b>年&nbsp;龄</b></td><td><input type="text" name="userage" value="<%=rs.getInt("userage") %>" readonly/></td></tr>
  <tr><td bgcolor="#FFCCFF" align="center"><b>性&nbsp;别</b></td><td><input type="text" name="usergender" value="<%=rs.getString("usergender") %>" readonly/></td></tr>
  <tr><td bgcolor="#FFCCFF" align="center"><b>学&nbsp;历</b></td><td><input type="text" name="useredu" value="<%=rs.getString("useredu") %>" readonly/></td></tr>
  <tr><td bgcolor="#FFCCFF" align="center"><b>电&nbsp;话</b></td><td><input type="text" name="userphone" value="<%=rs.getLong("userphone") %>" readonly/></td></tr>
  <tr><td bgcolor="#FFCCFF" align="center"><b>住&nbsp;址</b></td><td><input type="text" name="useraddress" value="<%=rs.getString("useraddress") %>" readonly/></td></tr>
  <tr><td bgcolor="#FFCCFF" colspan="2" align="center"><input type="submit" value="删除" class="button green"/>
